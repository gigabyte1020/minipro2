...
<head>
	<title>Lively Ride Travel Category Flat Bootstrap responsive Website Template | Short Codes :: w3layouts</title>
	<!-- Meta-tags -->
...
<body>
	...
	<div class="typo inner-padding">
		<div class="container">
			...
			<h3 class="tittle-w3">Typography</h3>
			<!-- //tittle-w3layouts heading -->
			<div class="grid_3 grid_4 mkstyles">
			...
			<div class="grid_3 grid_5 allahsuperl">
				<h3>Progress Bars</h3>
			...
			<div class="grid_3 grid_5 allahsuperls">
				<h3>Alerts</h3>
			...
			<div class="grid_3 grid_5 contentmkinfo">
				<h3>Breadcrumbs</h3>
				<ol class="breadcrumb">
			...
			<div class="grid_3 grid_5 textan">
				<h3>Badges</h3>
				<div class="col-md-6 contentmkits-mkstyles">
				...
				<div class="col-md-6 allahsuper-contentmkits">
			...
			<div class="grid_3 grid_5 contentmk">
				<h3>Wells</h3>
				<div class="well">
			...
			<ul class="list-group allahsuper-contentmk">
			...
			<div class="input-group input-group-lg allahsuper_mkstyles">
			...
			<div class="input-group input-group-sm allahsuper_mkstyles">
