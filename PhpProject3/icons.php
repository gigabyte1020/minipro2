...
<head>
	<title>Lively Ride Travel Category Flat Bootstrap responsive Website Template | Icons :: w3layouts</title>
	<!-- Meta-tags -->
...
<body>
	...
	<!-- //banner -->
	<!-- icons page-->
	<div class="main-grid-border inner-padding">
		<div class="container">
			<!-- tittle-w3layouts heading -->
			<h2 class="tittle-w3">Font Awesome Icons</h2>
			<!-- //tittle-w3layouts heading -->
