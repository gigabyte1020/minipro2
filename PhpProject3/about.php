...
<body>
	...
	<div class="agile-about-top">
		<div class="container">
					...
					<ul class="rslides" id="slider">
						<li>
							<div class="slider-img">
								<img src="images/1.jpg" class="img-responsive" alt="Lively Ride">
							</div>
						</li>
						<li>
							<div class="slider-img">
								<img src="images/2.jpg" class="img-responsive" alt="Lively Ride">
							</div>
						</li>
						<li>
							<div class="slider-img">
								<img src="images/3.jpg" class="img-responsive" alt="Lively Ride">
							</div>
						</li>
						<li>
							<div class="slider-img">
								<img src="images/4.jpg" class="img-responsive" alt="Lively Ride">
							</div>
						</li>
			...
			<div class="col-md-5 ab-text">
				...
				<p class="para-w3l">Etiam quis quam auctor, cursus ipsum a, placerat dui. Aliquam erat volutpat. Donec bibendum viverra commodo. Morbi erat
					est, fringilla id sollicitudin sed, hendrerit nec est. Fusce maximus scelerisque turpis vel tempus Morbi scelerisque
					a dolor vel feugiat. Nunc volutpat, magna in interdum commodo, magna orci venenatis risus, eu congue dolor ante quis
					eros.
				</p>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="team" id="team">
		<div class="container">
			<h3 class="tittle-w3">Meet Our Team</h3>
			<div class="agile_team_grids">
				<div class="col-md-3 agile_team_grid">
					...
					<div class="agile_team_grid1">
						...
						<h4>Jordan McDonald</h4>
						<span class="designation">Interpreter</span>
						<p class="para-w3l">Etiam quis quam auctor, cursus ipsum a, placerat dui. </p>
				...
				<div class="col-md-3 agile_team_grid">
					<div class="agile_team_grid1">
						...
						<h4>Danielle Ryan</h4>
						<span class="designation">Tour Operator</span>
						<p class="para-w3l">Etiam quis quam auctor, cursus ipsum a, placerat dui. </p>
						<ul class="top-icons team-icon">
							<li>
								<a href="#">
