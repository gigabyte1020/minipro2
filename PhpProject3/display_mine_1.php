...
<body>
 ...
 <?php include ("banner.php")?>
	...
	<div class="gallery">
		<div class="container">
			<h2 class="tittle-w3">My Rentals</h2>
...
$result = mysqli_query($db_connection,"SELECT * FROM rent WHERE rent_hostid='$hstid'");
...
?>
<a href="upload_rent.php" class="btn btn-info btn-lg">Add a rental</a>
		</div>
	</div>
	<!-- //gallery -->
	<!-- Newsletter -->
