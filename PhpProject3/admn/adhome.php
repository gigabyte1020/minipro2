  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="adhome.php.html"><img src="images/logo.svg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="adhome.php.html"><img src="images/logo-mini.svg" alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="adhome.php.html">
...
//    echo "<div align=center><img src=". $image_show."></div>";
  ...
  echo "<td>" . $row['rent_rules'] . "</td>";
   echo "<td>" . $row['rent_add'] . "</td>";
   ?> <td><div id="myspecialdiv" style="  min-width: 500px;
  min-height: 475px;
  width: fit-content;
  height: fit-content;">
...
?><td><a href="edit1.php?id=<?php echo $row['rent_id']; ?>">Edit</a></td>
    <td><a href="del1.php?id=<?php echo $row['rent_id']; ?>">Delete</a></td>
    <?php
  echo "</tr>";
